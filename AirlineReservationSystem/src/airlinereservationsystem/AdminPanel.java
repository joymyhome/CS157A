...
public class AdminPanel extends javax.swing.JFrame {
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addComponent(updateFlight, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void viewAllFlightsActionPerformed(java.awt.event.ActionEvent evt) {                                               
        viewAllFlights();
    }                                              

    private void popularFlightsActionPerformed(java.awt.event.ActionEvent evt) {                                               
        viewMostPopularFlight();
    }                                              

    private void CustNoBookingsActionPerformed(java.awt.event.ActionEvent evt) {                                               
        viewCustNoBookings();
    }                                              

    private void insertFlightActionPerformed(java.awt.event.ActionEvent evt) {                                             
        insertFlight();
    }                                            
    ...
    private void arriveTimeActionPerformed(java.awt.event.ActionEvent evt) {                                           
    }                                          

    private void departLocActionPerformed(java.awt.event.ActionEvent evt) {                                          
    }                                         

    private void destinationActionPerformed(java.awt.event.ActionEvent evt) {                                            
    }                                           

    private void intFlightNumActionPerformed(java.awt.event.ActionEvent evt) {                                             
    }                                            
    ...
    private void numAvailableSeatsActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        // Searches for number of available seats of certain flight
        viewNumAvailSeats();
    }                                                 

    private void archiveFlightActionPerformed(java.awt.event.ActionEvent evt) {                                              
        viewAllArchivedFlights();
    }                                             

    private void flightLocTimeDiffDateActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        flightDepLocTimeDiffDate();
    }                                                     

    private void topTwoDestActionPerformed(java.awt.event.ActionEvent evt) {                                           
        viewTopTwoDest();
    }                                          

    private void topDestDepartLocActionPerformed(java.awt.event.ActionEvent evt) {                                                 
